...
class ProductInfoCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => ProductPicInfoCreateNestedManyWithoutProductInfosInput,
  })
  @ValidateNested()
  @Type(() => ProductPicInfoCreateNestedManyWithoutProductInfosInput)
  @IsOptional()
  @Field(() => ProductPicInfoCreateNestedManyWithoutProductInfosInput, {
    nullable: true,
  })
