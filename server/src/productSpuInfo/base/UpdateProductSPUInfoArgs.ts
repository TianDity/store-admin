...
@ArgsType()
class UpdateProductSPUInfoArgs {
  @Field(() => ProductSPUInfoWhereUniqueInput, { nullable: false })
  where!: ProductSPUInfoWhereUniqueInput;
  @Field(() => ProductSPUInfoUpdateInput, { nullable: false })
  data!: ProductSPUInfoUpdateInput;
}

export { UpdateProductSPUInfoArgs };
