...
@InputType()
class ProductSPUInfoCreateInput {
  @ApiProperty({
    required: false,
    type: Number,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => ProductPicInfoCreateNestedManyWithoutProductSpuInfosInput,
  })
  @ValidateNested()
  @Type(() => ProductPicInfoCreateNestedManyWithoutProductSpuInfosInput)
  @IsOptional()
  @Field(() => ProductPicInfoCreateNestedManyWithoutProductSpuInfosInput, {
    nullable: true,
  })
...
export { ProductSPUInfoCreateInput };
