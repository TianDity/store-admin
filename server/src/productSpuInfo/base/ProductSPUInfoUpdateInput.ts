...
@InputType()
class ProductSPUInfoUpdateInput {
  @ApiProperty({
    required: false,
    type: Number,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => ProductPicInfoUpdateManyWithoutProductSpuInfosInput,
  })
  @ValidateNested()
  @Type(() => ProductPicInfoUpdateManyWithoutProductSpuInfosInput)
  @IsOptional()
  @Field(() => ProductPicInfoUpdateManyWithoutProductSpuInfosInput, {
    nullable: true,
  })
...
export { ProductSPUInfoUpdateInput };
