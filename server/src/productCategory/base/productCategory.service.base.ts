...
import { Prisma, ProductCategory, ProductSPUInfo } from "@prisma/client";
...
export class ProductCategoryServiceBase {
  ...
  async findProductOneCategoryId(
    parentId: string,
    ...
    return this.prisma.productCategory
      ...
      .productOneCategoryId(args);
  }

  async findProductThreeCategoryId(
    parentId: string,
    args: Prisma.ProductSPUInfoFindManyArgs
  ): Promise<ProductSPUInfo[]> {
    return this.prisma.productCategory
      ...
      .productThreeCategoryId(args);
  }

  async findProductTwoCategoryId(
    parentId: string,
    args: Prisma.ProductSPUInfoFindManyArgs
  ): Promise<ProductSPUInfo[]> {
    return this.prisma.productCategory
