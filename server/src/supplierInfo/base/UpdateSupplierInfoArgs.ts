...
@ArgsType()
class UpdateSupplierInfoArgs {
  @Field(() => SupplierInfoWhereUniqueInput, { nullable: false })
  where!: SupplierInfoWhereUniqueInput;
  @Field(() => SupplierInfoUpdateInput, { nullable: false })
  data!: SupplierInfoUpdateInput;
}

export { UpdateSupplierInfoArgs };
