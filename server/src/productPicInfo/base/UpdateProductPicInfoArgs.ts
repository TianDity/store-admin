...
@ArgsType()
class UpdateProductPicInfoArgs {
  @Field(() => ProductPicInfoWhereUniqueInput, { nullable: false })
  where!: ProductPicInfoWhereUniqueInput;
  @Field(() => ProductPicInfoUpdateInput, { nullable: false })
  data!: ProductPicInfoUpdateInput;
}

export { UpdateProductPicInfoArgs };
