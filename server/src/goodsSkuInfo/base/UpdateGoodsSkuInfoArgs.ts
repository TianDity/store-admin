...
@ArgsType()
class UpdateGoodsSkuInfoArgs {
  @Field(() => GoodsSkuInfoWhereUniqueInput, { nullable: false })
  where!: GoodsSkuInfoWhereUniqueInput;
  @Field(() => GoodsSkuInfoUpdateInput, { nullable: false })
  data!: GoodsSkuInfoUpdateInput;
}

export { UpdateGoodsSkuInfoArgs };
