...
import { ProductPicInfoCreateNestedManyWithoutProductSpuInfosInput } from "./ProductPicInfoCreateNestedManyWithoutProductSpuInfosInput";
import { SupplierInfoWhereUniqueInput } from "../supplierInfo/SupplierInfoWhereUniqueInput";

export type ProductSPUInfoCreateInput = {
  ...
  picInfoProductId?: ProductPicInfoCreateNestedManyWithoutProductSpuInfosInput;
  price?: number | null;
